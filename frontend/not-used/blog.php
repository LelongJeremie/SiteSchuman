          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto main-nav ">
              ...
              <li class="nav-item dropdown dropdown-slide">
                ...
                <div class="dropdown-menu">
                  ...
                  <a class="dropdown-item" href="dashboard-favourite-ads.php">Dashboard Favourite Ads</a>
                  <a class="dropdown-item" href="dashboard-archived-ads.php">Dashboard Archived Ads</a>
                  <a class="dropdown-item" href="dashboard-pending-ads.php">Dashboard Pending Ads</a>
                </div>
              </li>
              <li class="nav-item dropdown dropdown-slide">
                ...
                <div class="dropdown-menu">
                  ...
                  <a class="dropdown-item" href="store.php">Store Single</a>
            ...
            <ul class="navbar-nav ml-auto mt-10">
              <?php if (isset($_SESSION["id"])){   ?>
                ...
                <li class="nav-item">
                  <a class="nav-link text-white add-button" href="frontend/view/ad-listing.php"><i class="fa fa-plus-circle"></i> Ajouter au panier </a>
                </li>
              <?php } else {
